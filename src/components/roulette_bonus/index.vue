        ...
        <div class="roulette-bonus-dialog-header-right">
            <v-menu offset="14" content-class="roulette-bonus-help-menu" :scrim="false">
                <template v-slot:activator="{ props }">
                    <v-btn class="roulette-bonus-dialog-help-bg mr-4" v-bind="props" icon="true" width="34" height="34">
                ...
                <v-list theme="dark" bg-color="#211F31" width="439" height="596">
                    <p class="text-900-16 gray mt-6 text-center">{{ t('vip.roulette_bonus.help_menu.title_text') }}</p>
                    <p class="text-400-12 gray mt-4 mx-6 ">{{ t('vip.roulette_bonus.help_menu.text_1') }}</p>
                    <p class="text-400-12 gray mt-4 mx-6 ">{{ t('vip.roulette_bonus.help_menu.text_2') }}</p>
                    <p class="text-900-12 gray mt-4 mx-6 ">{{ t('vip.roulette_bonus.help_menu.text_3') }}</p>
                    <p class="text-400-12 gray mx-6 ">{{ t('vip.roulette_bonus.help_menu.text_4') }}</p>
                    <p class="text-400-12 gray mx-6 ">{{ t('vip.roulette_bonus.help_menu.text_5') }}</p>
                    <p class="text-400-12 gray mx-6 ">{{ t('vip.roulette_bonus.help_menu.text_6') }}</p>
                    <p class="text-900-12 gray mt-4 mx-6 ">{{ t('vip.roulette_bonus.help_menu.text_7') }}</p>
                    <p class="text-400-12 gray mx-6 ">{{ t('vip.roulette_bonus.help_menu.text_8') }}</p>
                    <p class="text-400-12 gray mx-6 ">{{ t('vip.roulette_bonus.help_menu.text_9') }}</p>
                    <p class="text-400-12 gray mx-6 ">{{ t('vip.roulette_bonus.help_menu.text_10') }}</p>
                </v-list>
            </v-menu>
        ...
        <div class="roulette-bonus-dialog-winner-body" :style="{ height: winnerBodyHeight + 'px' }">
            ...
            <div class="roulette-bonus-dialog-winner-content">
                ...
                <div class="my-2" v-else>
                    <v-row v-for="(prizeItem, prizeIndex) in roulettePrizeHistory" :key="prizeIndex" class="ma-0 mx-4 pa-0">
