...
<template>
    <v-row class="mx-2 mt-4">
        <v-table class="forms-bonus-table-bg" theme="dark" fixed-header height="700px">
            ...
            <tbody :class="mobileWidth < 600 ? 'text-400-12 text-center' : 'text-400-14 text-center'">
                    ...
                    <td class="d-flex align-center justify-center">
                        <div style="width: 20px; height: 20px; background: #414968; border-radius: 20px; position: relative;" v-if="item.amount">
                            <el-tooltip placement="top" effect="customized">
                                ...
                                <v-icon style="position: absolute; left: 50%; top: 50%; transform: translate(-50%, -50%);">mdi-chevron-up</v-icon>
                            </el-tooltip>
                        </div>
    ...
    <v-row class="ma-4 mx-2">
        ...
        <v-col cols="6" md="8" lg="8" class="d-flex"  style="margin-left: 10px!important; padding-right: 0px!important; padding-left: 0px!important;">
